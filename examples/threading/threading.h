 ...
 */
struct thread_data {
    // Pointer to the mutex the thread will operate on
    pthread_mutex_t *mutex;

    // Number of milliseconds to wait before trying to obtain the mutex
    int wait_to_obtain_ms;

    // Number of milliseconds to wait after obtaining the mutex before releasing it
